...
function Hero() {
  return (
    <>
      ...
      />
      <div className="h-[80vh] z-20 gap-y-10 flex flex-col justify-center items-center max-w-5xl mx-auto">
        <h1 className="font-extrabold text-center text-4xl xl:text-6xl xl:leading-[4.5rem] p-5">
          Unlock Your Fitness Potential with{" "}
          <span className="text-black bg-amber-400 px-2 pb-1">
            Minimum <span className="underline">Strength</span>
          </span>
        </h1>
        <p className="text-center xl:text-xl px-10">
        ...
        <Link
          to="#"
          className="py-5 px-8 text-xl xl:text-2xl font-bold ring-1 ring-amber-500 rounded-full flex justify-center cursor-pointer"
        >
          Book a Call
        </Link>
      </div>
